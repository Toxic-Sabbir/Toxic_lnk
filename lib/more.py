...
def chk():
    try:
        main_ver = requests.get("https://raw.githubusercontent.com/Toxic-Sabbir/Toxic_lnk/main/lib/.version").text
    except:
...
def update():
    ...
    if not (tool_ver == main_ver):
        ...
        time.sleep(1)
        os.system("cd .. && rm -rf Toxic_lnk && git clone https://github.com/Toxic-Sabbir/Toxic_lnk > /dev/null 2>&1")
        psb("\n\033[92m    \033[94m[\033[37m*\033[94m]\033[92m Tool Updted Successfully...")
        psb("\n    \033[94m[\033[37m*\033[94m]\033[92m Starting Tool...\033[37m")
        time.sleep(1)
        os.system("cd .. && cd Toxic_lnk && clear && python Toxic_lnk.py")
    else:
        psb("\n\033[92m    \033[94m[\033[37m*\033[94m]\033[92m You Are Using The Latest Version Of Toxic-lnk...")
...
def logout():
    ...
    print("\033[93m[ \033[94mhttps://github.com/Toxic-Sabbir \033[93m] \033[37m\n".center(columns+18))
    time.sleep(0.8)
    sys.exit()
